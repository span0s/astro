...
bool writeEphemToAGI(std::string outfile, Ephemeris& ephem) {
    ...
    fprintf(fp, "EphemerisTimePosVel\n");
    for (int ii = 0; ii < (int)ephem.states_.size(); ii++) {
        fprintf(
            fp, "%.6lf %.12lf %.12lf %.12lf %.12lf %.12lf %.12lf\n",
